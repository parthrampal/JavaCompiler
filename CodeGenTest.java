...
//		show(program);  //It may be useful useful to show this here if code generation fails
	...
	public void testminus1() throws Exception {
		...
		String input = prog + "{int x; x:= 4; float y; y:=2.0; show(x-y);}";
		byte[] bytecode = genCode(input);
		String[] commandLineArgs = {};
		runCode(prog, bytecode, commandLineArgs);
		show("Log:\n" + RuntimeLog.globalLog);
		...
		@Test
	public void testpolar1() throws Exception {
		String prog = "testPolar";
		String input = prog + "{int x; x:= 4; int y; y:=2; float p; p := polar_r[x,y]; show p;}";
		byte[] bytecode = genCode(input);
		String[] commandLineArgs = {};
		runCode(prog, bytecode, commandLineArgs);
		show("Log:\n" + RuntimeLog.globalLog);
	...
	public void test09() throws Exception {
		...
		String[] commandLineArgs = { "C:\\\\Users\\\\Parth Rampal\\\\Documents\\\\PLP\\\\testimage1.png" };
		runCode(prog, bytecode, commandLineArgs);
		show("Log:\n" + RuntimeLog.globalLog);
		// assertEquals("entering main;3;leaving main;",
		// RuntimeLog.globalLog.toString());
	...
	public void test25() throws Exception {
		...
		String[] commandLineArgs = { "C:\\Users\\Parth Rampal\\Documents\\PLP\\testimage1.png", "C:\\Users\\Parth Rampal\\Documents\\PLP\\testimage2.png" };
		runCode(prog, bytecode, commandLineArgs);
		show("Log:\n" + RuntimeLog.globalLog);
		// assertEquals("entering main;3;leaving main;",
		// RuntimeLog.globalLog.toString());
...
@Test
	public void readImageFromCommandLineAndScale() throws Exception {
		...
		byte[] bytecode = genCode(input);
		String[] commandLineArgs = {"C:\\Users\\Parth Rampal\\Documents\\PLP\\testimage1.png"}; //create command line argument array to initialize params, none in this case
		runCode(prog, bytecode, commandLineArgs);
		show("Log:\n" + RuntimeLog.globalLog);
		//assertEquals("entering main;3;leaving main;",RuntimeLog.globalLog.toString());
...
@Test
	...
	public void if12() throws Exception {
		...
		String[] commandLineArgs = {"C:\\Users\\Parth Rampal\\Documents\\PLP\\testimage2.png", "true"}; //create command line argument array to initialize params, none in this case
	...
	public void if22() throws Exception {
	...
	public void while1() throws Exception {
		...
		String[] commandLineArgs = {"C:\\Users\\Parth Rampal\\Documents\\PLP\\testimage2.png", "true"};
	...
	public void showTits() throws Exception {
		...
		String[] commandLineArgs = {"C:\\Users\\Parth Rampal\\Documents\\PLP\\testimage1.png", "writtenImage1.png"};
...
@Test
	...
	public void Prog39() throws Exception {
		...
		String input = prog;
		byte[] bytecode = genCode(input);
		String[] commandLineArgs = {"C:\\Users\\Parth Rampal\\Documents\\PLP\\testimage2.png"};
	...
	public void writeTest() throws Exception {
		...
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {"C:\\Users\\Parth Rampal\\Documents\\PLP\\testimage1.png", "C:\\Users\\Parth Rampal\\Documents\\PLP\\testimage2.png"}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;leaving main;",RuntimeLog.globalLog.toString());
	}
...
//			assertEquals("entering main;36.758343;leaving main;",RuntimeLog.globalLog.toString());
	...
	public void testExpressionPixelConstructor1() throws Exception {
		...
		runCode("prog", bytecode, commandLineArgs);
		show("Log:\n " + RuntimeLog.globalLog);
		assertEquals("entering main;0;-1;leaving main;", RuntimeLog.globalLog.toString());
	}
...
//
	...
	public void testExpressionPixelConstructor2() throws Exception {
		...
		@Test
	public void testExpressionFunctionApp1() throws Exception {
		String prog = "prog";
		...
		runCode("prog", bytecode, commandLineArgs);
		show("Log:\n " + RuntimeLog.globalLog);
		assertEquals("entering main;61;31;leaving main;", RuntimeLog.globalLog.toString());
	}
		@Test
	...
	public void testScope1() throws Exception {
		...
		@Test
	public void owhile1() throws Exception {
		String prog = "prog";
		String input = prog + "{boolean b; \n b := false; \n while(b){ \n  show b;\n  b := true; \n}; \nshow b;}";
		byte[] bytecode = genCode(input);
		String[] commandLineArgs = {};
		runCode("prog", bytecode, commandLineArgs);
		show("Log:\n " + RuntimeLog.globalLog);
	...
	@Test
	public void owhile2() throws Exception {
		String prog = "prog";
		String input = prog + "{boolean b; \n b := true; \n while(b){ \n  show b;\n  b := false; \n}; \nshow b;} ";
		byte[] bytecode = genCode(input);
		String[] commandLineArgs = {};
...
/****************************************************************************************************/
	...
	public void declareAndAssign5() throws Exception {
		String prog = "fileLit";
		String input = prog + "{int a; int b; b := 4; a := b;} ";	
		System.out.println(input);
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
